...
<div class="wrapper">
 ...
 <?php
	if(!isset($title)){
      $image=$title=$short_description=$link=$order_by="";
	}
 ?>
...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?=$page_title;?>
        <small>Add/Update Gallery</small>
      </h1>
      <ol class="breadcrumb">
          ...
          <?= form_open('#', array('class' => 'form', 'id' => 'category-form', 'enctype'=>'multipart/form-data', 'method'=>'POST'));?>
                <input type="hidden" id="base_url" value="<?php echo $base_url; ?>">
                  <div class="form-group">
                      <label for="image" class="col-sm-2 control-label"><?= $this->lang->line('image'); ?></label>
                      <div class="col-sm-4">
                          <input type="file" class="form-control" name="image">
                          
                          <span id="slider_image_msg" style="display:block;" class="text-danger">
                            <!-- <?= $slider_image_msg; ?> -->
                              Max Width/Height: 200px * 150px & Size: 200kB
                          </span>
                          <?php if($image){ ?>

                      ...
                      <?= form_open('#', array('class' => 'form', 'id' => 'items-form', 'enctype'=>'multipart/form-data', 'method'=>'POST'));?>
                        ...
                        <div class="box-body">
                              ...
                              <div class="form-group col-md-4">
                                 ...
                                 <?php if($item_image){ ?>
                                    <a href="<?= base_url($item_image) ?>" target="_blank">
                                       <img src="<?= base_url($item_image) ?>" alt="" width="35px">
                                    </a>
                                 <?php } ?>
                              </div>
                              ...
                              <div class="form-group col-md-4">
                                 ...
                                 <?php if($item_image_two){ ?>
                                    <a href="<?= base_url($item_image_two) ?>" target="_blank">
                                       <img src="<?= base_url($item_image_two) ?>" alt="" width="35px">
                                    </a>
                                 <?php } ?>
                              </div>
                              <div class="form-group col-md-4">
                                 ...
                                 <?php if($item_image_three){ ?>
                                    <a href="<?= base_url($item_image_three) ?>" target="_blank">
                                       <img src="<?= base_url($item_image_three) ?>" alt="" width="35px">
                                    </a>
                                 <?php } ?>
                              </div>
                              <div class="form-group col-md-4">
                                 ...
                                 <?php if($item_image_four){ ?>
                                    <a href="<?= base_url($item_image_four) ?>" target="_blank">
                                       <img src="<?= base_url($item_image_four) ?>" alt="" width="35px">
                                    </a>
                                 <?php } ?>
                              </div>
                              <div class="form-group col-md-4">
                                 ...
                                 <?php if($item_image_five){ ?>
                                    <a href="<?= base_url($item_image_five) ?>" target="_blank">
                                       <img src="<?= base_url($item_image_five) ?>" alt="" width="35px">
                                    </a>
                                 <?php } ?>
                              </div>
                           </div>
                           ...
                           <div class="row">
							 ...
							 <div class="form-group col-md-4">
                                 <label for="web_price" class="control-label"> price (For E-commerce)<span class="text-danger">*</span></label>
                                 <input type="text" class="form-control only_currency " id="web_price" name="web_price" placeholder="Price"  value="<?php print $web_price; ?>" >
                              </div>
							 <div class="form-group col-md-4">

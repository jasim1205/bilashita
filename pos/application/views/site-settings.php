                                 ...
                                 <div class="col-md-12">
                                       <div class="box-body">
                                          <div class="row">
                                             ...
                                             <div class="col-md-6">
                                                <div class="form-group">
                                                   <label for="subcategory_init" class="col-sm-4 control-label"><?= $this->lang->line('subcategory'); ?><label class="text-danger">*</label></label>
                                                   <div class="col-sm-8">
                                             ...
                                             <div class="col-md-6">
                                                <div class="form-group">
                                                   <label for="childcategory_init" class="col-sm-4 control-label"><?= $this->lang->line('childcategory'); ?><label class="text-danger">*</label></label>
                                                   <div class="col-sm-8">
                                                      <input type="text" class="form-control" id="childcategory_init" name="childcategory_init" placeholder="" value="<?php print $childcategory_init; ?>" >
                                                      <span id="childcategory_init_msg" style="display:none" class="text-danger"></span>
                                                   </div>
                                                </div>
                                             </div>
                                             <div class="col-md-6">

      ...
      <div class="bg-white rounded shadow p-3">
        ...
        <div class="m-auto my-3 w-75">
          <form action="{{ route('customer.store') }}" method='post'>
            ...
            <button type="submit" class="submit shadow p-2 px-3 btn btn-primary">Submit</button> OR
            <a class="submit shadow m-1 py-2 btn btn-success" href="{{ route('login') }}">Login</a>

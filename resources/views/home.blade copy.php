          ...
          <div class="product-row my-3">
            <div class="row justify-content-center">
                ...
                <div class="col-md-4 col-lg-3 col-xl-2 col-6">
                    <div class="card shadow mb-3" style=" max-height:355px; margin:auto">
                      <a href="#">
                      ...
                      <div class="card-body">
                        ...
                        <p class="card-title text-center m-0 p-0">{{ $p->web_price .' '.'TK' }}</p>
          ...
          <div class="row justify-content-center">
            ...
            @forelse ($category as $cat)
                <div class="col-sm-6 col-lg-4 col-xl-3 mb-3">
                    <a  href="{{ route('category.product.list',$cat->id) }}">

        ...
        <div class="container">
            ...
            <div class="product-ads-group mx-auto">
                ...
                <a href="{{$item?->link}}" target="_blank">
                    <img class="col-md-4 hero-img rounded" src="{{ asset('./../pos/uploads/gallery_image/'.$item?->image) }}" width="180px" height="150px" alt="card-img-1">
                </a>
                            ...
                            <div class="d-flex justufy-content-between align-items-center">
                                ...
                                <div class="card-body">
                                    <a href="{{ route('product_details.singleProduct',$p->id) }}">
                                        ...
                                        <p class="p-0 m-0 regular-price"><strike class="regular-price">{{$p->old_price}}</strike></p>
                                ...
                                <form action="{{ route('add-to-cart') }}" method="post" class="d-none d-md-block">
                                    ...
                                    <div class="card-button">
                                        <button onclick="addToCard('{{$p->id }}')" type="button" class="cartsubmit btn">

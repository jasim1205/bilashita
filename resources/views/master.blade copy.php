        ...
        <div class="container">
            ...
            <div class="ms-auto customer-seciton mobile-bg p-1">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink" style="background-color: #FC0101;">
                        @if(Session::get('userId'))
                        <li><a class="dropdown-item" href="{{ route('customer.dashboard') }}">Dashboard</a></li>
                        <li><a class="dropdown-item" href="{{ route('logOut') }}">Logout</a></li>
                        @else
                        <li><a class="dropdown-item text-white" href="{{ route('register') }}">Registration</a></li>

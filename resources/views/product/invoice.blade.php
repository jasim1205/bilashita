                ...
                <div class="row">
                    <div class="col">
                        <a target="_blank" href="{{ route('home') }}">
                            <img src="{{ asset('assets/resource') }}uploads/users/rsz_337256790_913298886604594_1652977156781857081_n.png" height="60px" width="120px" data-holder-rendered="true" />
                            </a>
                    </div>
                    <div class="col company-details">
                        <h2 class="name">
                            <a target="_blank" href="{{ route('home') }}">
                                A R Chattala Motors & Oil Suppliers
                            </a>
                        </h2>
                        <div>Middle Supariwala Para, Dewanhat, Chattagram</div>
                        <div>01970557853</div>
